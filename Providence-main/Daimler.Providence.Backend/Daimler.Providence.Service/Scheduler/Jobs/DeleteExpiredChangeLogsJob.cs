...
namespace Daimler.Providence.Service.Scheduler.Jobs
{
    ...
    public class DeleteExpiredChangeLogsJob : IJob
    {
        ...
        public DeleteExpiredChangeLogsJob(IMaintenanceBusinessLogic maintenanceBusinessLogic)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (new ElapsedTimeLogger())
            {
                ...
                try
                {
                    ...
                    await _maintenanceBusinessLogic.DeleteExpiredChangeLogs(cutOffDate, context.CancellationToken).ConfigureAwait(false);
