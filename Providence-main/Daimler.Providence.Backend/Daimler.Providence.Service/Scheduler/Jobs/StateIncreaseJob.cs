...
{
    /// <summary>
    /// Job for checking whether a IncreaseRule should be triggered or not.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [DisallowConcurrentExecution]
    public class StateIncreaseJob : IJob
    {
        ...
        public StateIncreaseJob(IEnvironmentManager environmentManager)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (new ElapsedTimeLogger())
            {
                ...
                try
                {
                    await _environmentManager.CheckStateIncreaseRules().ConfigureAwait(false);
