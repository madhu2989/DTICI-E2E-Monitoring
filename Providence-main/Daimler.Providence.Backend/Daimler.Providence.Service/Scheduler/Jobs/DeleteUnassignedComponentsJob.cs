...
{
    /// <summary>
    /// Job for deleting unassigned Components.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [DisallowConcurrentExecution]
    public class DeleteUnassignedComponentsJob : IJob
    {
        ...
        public DeleteUnassignedComponentsJob(IMaintenanceBusinessLogic maintenanceBusinessLogic)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            using (new ElapsedTimeLogger())
            {
                ...
                try
                {
                    ...
                    await _maintenanceBusinessLogic.DeleteUnassignedComponents(cutOffDate, context.CancellationToken).ConfigureAwait(false);
